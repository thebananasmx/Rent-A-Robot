  ...
  return (
    <section className="py-24 bg-gradient-to-b from-white to-brand-primary/30 border-t border-gray-50">
      <div className="container mx-auto px-6 text-center">
        <div className="mb-12">
           <span className="text-brand-accent font-bold tracking-wider uppercase text-xs mb-2 block">Versatility</span>
           <h2 className="text-3xl md:text-4xl font-bold text-brand-dark mb-4">
             Adaptable to Your Corporate Image
           </h2>
           <p className="text-brand-muted max-w-2xl mx-auto text-lg">
             Our fleet is not just smart, it's elegant. We have multiple configurations to align perfectly with your brand's visual identity.
           </p>
        </div>
        ...
        <div className="relative max-w-5xl mx-auto">
          ...
          <img 
            ...
            alt="Pudu Robotics fleet adaptable to your brand" 
